...
def visualize_maze(matrix, bonus, start, end,route=None,outputname='output.txt'):
    ...
    plt.savefig('./'+outputname+'/bfs.jpg')
    plt.close()
...
def return_path(current_node,outputpath):
    ...
    while current is not None:
        ...
        cost+=1
    with open('./'+outputpath+'/bfs.txt', 'w') as outfile:
...
startime=time.time()
# bfs('input/level_1/input1.txt','onput/level_1/input1')
# endtime=time.time()
# print('ch phi tim duong:',endtime-startime)
